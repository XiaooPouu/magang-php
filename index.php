...
$resultItemsCustomer = $db->count('items_customers'); // Menghitung jumlah baris di tabel items_customers
$totalItemsCustomer = $resultItemsCustomer;

$resultInvoice = $db->count('invoice'); // Menghitung jumlah baris di tabel invoice
$totalInvoice = $resultInvoice;
            ...
            <div class="row">
              ...
              <div class="col-lg-3 col-6">
                ...
                <div class="small-box text-bg-danger">
                  ...
                  <a
                    href="<?=BASE_URL?>pages/dataItems_Costumer.php"
                    class="small-box-footer link-light link-underline-opacity-0 link-underline-opacity-50-hover"
                  >
                    More info <i class="bi bi-link-45deg"></i>
                  </a>
              ...
              <div class="col-lg-3 col-6">
                <!-- small box -->
                <div class="small-box text-bg-info text-light">
                  <div class="inner">
                    <h3><?= $totalInvoice?></h3>
                    <p>Invoice</p>
                  </div>
                  ...
                  <a
                    href="<?=BASE_URL?>pages/dataInvoice.php"
                    class="small-box-footer link-light link-underline-opacity-0 link-underline-opacity-50-hover"
                  >
                    More info <i class="bi bi-link-45deg"></i>
                  </a>
