                        ...
                        <tr class="align-middle">
                          ...
                          <td class="text-center"><div class="btn-group">
                              ...
                              <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="<?= $BaseUrl->getUrlFormSupplier($sp['id'])?>"><i class="bi bi-pencil me-1"></i> Edit</a></li>
                                <li><a class="dropdown-item" href="<?= $BaseUrl->getUrlControllerDeleteSupplier($sp['id']) ?>" onclick="return confirm('Are you sure?')"><i class="bi bi-trash me-1"></i>Delete</a></li>
                              </ul>
                            </div>
                          </td>
                        </tr>
